...
?>
  <body>
    <div class="page-position">
      ...
      <div class="scion-scheme">
        <div class="scion-scheme-container">
          <div class="scion-scheme-content">
            <h1>introduction to Scion Coalition Scheme</h1>
            <p>
              The Scion Coalition Scheme is an intensive, specially-tailored
              training programme run by Netmatters in order to give willing
